...
namespace EbayMonopolyTests.Pages
{
    public class ItemDetailsPage
    {
        ...
        //private IWebElement ShippingDetails => _driver.FindElement(By.XPath("//div[contains(@class, 'ux-labels-values__labels ') and contains(., 'Shipping:')]/following-sibling::div//button[child::span[text()='See details']]"));
